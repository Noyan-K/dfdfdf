...
import { ClothSexEnum, DocumentTypeOfProductEnum, MannequinSexEnum } from '@prisma/client';
...
export class ProductService {
            ...
            include: {
                ProductDocument: {
                    where: {
                        ...
                        mannequin_sex:
                            sex === 'FEMALE' ? MannequinSexEnum.FEMALE : MannequinSexEnum.MALE,
                    },
                    include: {
                        Document: true,
                    },
    ...
    findOne(id: number, mannequin_sex?: MannequinSexEnum): Promise<Product | null> {
